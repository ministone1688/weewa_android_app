...
public class GattUtils {
    private static final String TAG = BleConstants.TAG_PREFIX + "GattUtils";
    ...
    public static class RequestQueue {
        ...
        public void next() {
            ...
            if (request.mRequestType == GattRequest.REQUEST_READ_CHAR) {
                ...
                builder.append("}");
                Log.d(TAG, "Bluetooth GattRequest.REQUEST_WRITE_DESC " + builder);
        ...
        for (BluetoothGattService service : serviceList) {
            if (service.getUuid().equals(serviceUuid)) {
                ...
                if (characteristics != null) {
                    for (BluetoothGattCharacteristic temp : characteristics) {
                        if (characteristicUuid.equals(temp.getUuid())) {
...
//        if (characteristics != null) {
//            for (BluetoothGattCharacteristic temp : characteristics) {
//                if (service.getCharacteristic(temp.getUuid()) != null) {
//                    return service.getCharacteristic(temp.getUuid());
//                }
//            }
//        }
        return null;
        ...
        if (characteristic != null) {
            ...
            if (descriptors != null) {
                for (BluetoothGattDescriptor descriptor : descriptors) {
                    if (characteristic.getDescriptor(descriptor.getUuid()) != null) {
                        return descriptor;
                    }
                }
            }
