package com.xh.hotme.widget.playerview;
/*
 ...
 *       </ul>
 *   <li>All attributes that can be set on {@link MyPlayerControlView} and {@link DefaultTimeBar} can
 ...
 *
 * The drawables used by {@link MyPlayerControlView} (with its default layout file) can be overridden
 * by drawables with the same names defined in your application. See the {@link MyPlayerControlView}
...
public class MyPlayerView extends FrameLayout implements AdViewProvider {
    ...
    @Nullable private MyPlayerControlView.VisibilityListener controllerVisibilityListener;
