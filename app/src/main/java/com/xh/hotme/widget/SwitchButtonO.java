...
/**
 * Create by zhaozhihui on 2019-06-11
 **/
...
public class SwitchButtonO extends CompoundButton {
    ...
    public static final int DEFAULT_TINT_COLOR = 0xF16C2F;
    ...
    public SwitchButtonO(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this.init(attrs);
    }

    public SwitchButtonO(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        float thumbRadius = Math.min(thumbWidth, thumbHeight) / DEFAULT_THUMB_MARGIN_DP;
        float backRadius = thumbRadius + density * DEFAULT_THUMB_MARGIN_DP;
        ...
        if (!this.mIsThumbUseDrawable && this.mThumbColor == null) {
            this.mThumbColor = ColorUtil.generateThumbColorWithTintColor(this.mTintColor);
            this.mCurrThumbColor = this.mThumbColor.getDefaultColor();
//            this.mCurrThumbColor = Color.WHITE;
        }
        ...
        if (!this.mIsBackUseDrawable && this.mBackColor == null) {
            this.mBackColor = ColorUtil.generateBackColorWithTintColor(this.mTintColor);
            this.mCurrBackColor = this.mBackColor.getDefaultColor();
//            this.mCurrBackColor =Color.parseColor("#3D9AF0");
            this.mNextBackColor = this.mBackColor.getColorForState(CHECKED_PRESSED_STATE, this.mCurrBackColor);
//            this.mNextBackColor = Color.parseColor("#3D9AF0");
        }
    ...
    public void setBackColorRes(int backColorRes) {
        this.setBackColor(ContextCompat.getColorStateList(this.getContext(), backColorRes));
    }
    ...
    public void setThumbColorRes(int thumbColorRes) {
        this.setThumbColor(ContextCompat.getColorStateList(this.getContext(), thumbColorRes));
    }
