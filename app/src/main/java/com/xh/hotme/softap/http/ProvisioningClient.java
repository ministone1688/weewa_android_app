 ...
 * under the License.
 */
package com.xh.hotme.softap.http;
...
public class ProvisioningClient {
    ...
    public List<WifiInfo> getWifiListInfo() throws JSONException, IOException {
        ...
        String url = endpoint + "/provision/wifiListInfo";
...
//        Response netResponse = OkHttpUtil.syncResponse(url);
//        if (netResponse == null || netResponse.body() == null) {
//            return result;
//        }
//
//        if (netResponse.code() != 204) {
//            String responseString = netResponse.body().string();
...
//        }
    ...
    private SSLSocketFactory getPinnedSSLSocketFactory(String crt) throws Exception {
        InputStream caCertInputStream = null;
        try {
            caCertInputStream = new ByteArrayInputStream(crt.getBytes(StandardCharsets.UTF_8));
            CertificateFactory cf = CertificateFactory.getInstance("X.509");
            Certificate caCert = cf.generateCertificate(caCertInputStream);
