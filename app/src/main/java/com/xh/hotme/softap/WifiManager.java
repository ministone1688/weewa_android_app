...
public class WifiManager {
    ...
    public static final String WEEWA_SOFTAP_NAME = "HotmeCam";
    public static final String WEEWA_SOFTAP_PWD = "";
    ...
    private WifiManager(Context context) {
        ...
        mWifiLock = mWifiManager.createWifiLock(WEEWA_SOFTAP_NAME);
        ...
        mNetworkCallback = new ConnectivityManager.NetworkCallback() {
            ...
            public void onUnavailable() {
                ...
                ConnectLogic.getInstance().setConnectIng(false);
                EventBus.getDefault().post(new NetWorkForQEvent(NetWorkForQEvent.UNAVAILABLE));
            ...
            public void onCapabilitiesChanged(@NonNull Network network,
                ...
                if (networkCapabilities.hasCapability(NetworkCapabilities.NET_CAPABILITY_INTERNET)) {
                    ...
                    EventBus.getDefault().post(new NetWorkForQEvent(NetWorkForQEvent.NET_CAPABILITY_INTERNET));
                }


                if (networkCapabilities.hasCapability(NetworkCapabilities.NET_CAPABILITY_VALIDATED)) {
                    Log.d(TAG, "NET_CAPABILITY_VALIDATED");
                    EventBus.getDefault().post(new NetWorkForQEvent(NetWorkForQEvent.NET_CAPABILITY_VALIDATED));
                }
            }
        };
    }
        ...
        if (results != null) {
            ...
            for (ScanResult result : results) {
                ...
                if (result.SSID == null || result.SSID.length() == 0 || result.capabilities.contains("[IBSS]")
                        || !result.SSID.trim().startsWith(WEEWA_SOFTAP_NAME)) {
                    continue;
                }
    ...
    public boolean connCustomNetWorkQ(String ssid, String password, String bssid, Data type) {
    ...
    public boolean connCustomNetWorkBySdk(String ssid, String pwd, String bssid, Data type) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q)
            return connCustomNetWorkQ(ssid, pwd, bssid, type);
        else
        ...
        private void handleNetworkStateChanged(Intent intent) {
            ...
            if (null != networkInfo && networkInfo.isConnected()) {
                ...
                if (wifiInfo != null && info != null) {
                    if (wifiInfo.getBSSID() != null && wifiInfo.getBSSID().equals(info.getBssid()) && !TextUtils.isEmpty(getConnectWifiSsid())) {
